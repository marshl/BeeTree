...
public class btInterfaceLoopXNode : btInterfaceInnerNode
{
	public override btFunctionNode CreateFunctionNode()
	{
		return new btFunctionLoopXNode();	
	}
	...
	{
		return "A LoopX node runs all of its children in order from left to right a number of times set using the slider." +
